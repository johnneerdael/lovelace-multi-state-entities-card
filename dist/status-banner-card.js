...
`,Lt={"top-left":"0 0","top-right":"100% 0","bottom-left":"0 100%","bottom-right":"100% 100%"};let Tt=class extends rt{setConfig(t){if(!t.entity)throw new Error("You need to define an entity");this._config={...bt,...t,color_map:{...bt.color_map,...t.color_map}}}getCardSize(){return!1===this._config?.show_status&&!1===this._config?.show_footer?2:3}shouldUpdate(t){if(t.has("_config"))return!0;if(t.has("hass")){const e=t.get("hass");if(!e)return!0;const i=this._config.entity;return e.states[i]!==this.hass.states[i]||(!(!this._config.timestamp_entity||e.states[this._config.timestamp_entity]===this.hass.states[this._config.timestamp_entity])||!(!this._config.secondary_info_entity||e.states[this._config.secondary_info_entity]===this.hass.states[this._config.secondary_info_entity]))}return!0}static getConfigElement(){return document.createElement("status-banner-card-editor")}static getStubConfig(){return{entity:"",rules:[{state:"on",title:"Active",subtitle:"System is running",icon:"mdi:check-circle",color:"#4CAF50"},{state:"off",title:"Inactive",subtitle:"System is idle",icon:"mdi:power-standby",color:"#9E9E9E"}],default:{title:"{{ state | upper }}",subtitle:"",icon:"mdi:information",color:"#2196F3"}}}render(){if(!this._config||!this.hass)return I``;const t=Et(this.hass,this._config.entity,this._config.rules,this._config.default,this._config.color_map,this._config.status_label),e=!1!==this._config.show_status,i=!1!==this._config.show_footer,s=!1!==this._config.show_accent,o=!1!==this._config.show_pattern,a=this._config.pattern_size??20,n=this._config.accent_width??60,r=this._config.accent_height??100,l=this._config.accent_full_background??!1,c=this._config.accent_start??"bottom-left",h=this._config.accent_end??"top-right",d=l?"none":function(t,e){if(t===e)return"none";const i=Lt[t],s=Lt[e],o=["top-left","top-right","bottom-left","bottom-right"],a={"top-left":["top-right","bottom-left"],"top-right":["top-left","bottom-right"],"bottom-left":["top-left","bottom-right"],"bottom-right":["top-right","bottom-left"]};let n=null;for(const i of o){if(i===t||i===e)continue;const s=a[t].includes(i),o=a[e].includes(i);if(s&&o){n=i;break}}return n||(n=a[t][0]),`polygon(${i}, ${s}, ${Lt[n]})`}(c,h),u=l?"100%":`${n}%`,p=l?"100%":`${r}%`,g=this._config.title_color,_=this._config.subtitle_color,f=this._config.timestamp_color,m=this._config.title_alignment??"right",v=this._config.icon_alignment??"right",b=this._config.timestamp_position??"bottom-left",$=this._config.button_position??"bottom-right";return I`
      <ha-card @click=${this._handleCardClick}>
        ...
        >
          ${s?I`<div
              ...
              ></div>`:q}
          ${this._renderHeader(t,m,v,g,_)}
          ${e&&t.statusText?this._renderStatusBox(t):q}
          ${i?this._renderFooterElements(t,b,$,f):q}
        </div>
      </ha-card>
    `}_renderHeader(t,e,i,s,o){const a=e===i,n=a?"right"===e?"flex-end":"flex-start":"space-between",r="left"===i?-1:1,l="left"===e?-1:1,c=e,h=a?"right"===e?"margin-right: 20px;":"margin-left: 20px;":"";return I`
      <div class="header" style="--header-height: ${this._config.header_height}">
        <div class="header-content" style="justify-content: ${n};">
    ...
    `}_renderFooterElements(t,e,i,s){const o=this._getTimestamp(),a=this._config.button_actions?.[0];if(!o&&!a)return I``;const n={"top-left":"top: 16px; left: 24px;","top-right":"top: 16px; right: 24px;","bottom-left":"bottom: 16px; left: 24px;","bottom-right":"bottom: 16px; right: 24px;"};if(o&&a&&e===i){const e=i.includes("right")?"flex-end":"flex-start";return I`
        <div class="footer-stack" style="${n[i]} align-items: ${e};">
          <div class="timestamp" style="${s?`color: ${s};`:""}">Last Check: ${o}</div>
          ${this._renderButton(a,t)}
        </div>
      `}return I`
      ${o?I`<div class="timestamp positioned" style="${n[e]} ${s?`color: ${s};`:""}">Last Check: ${o}</div>`:q}
      ${a?I`<div class="button-wrapper" style="${n[i]}">${this._renderButton(a,t)}</div>`:q}
    ...
    `}_renderTriangleSection(){if(!1===this._config.show_accent)return I``;const t=[{value:"top-left",label:"Top Left"},{value:"top-right",label:"Top Right"},{value:"bottom-left",label:"Bottom Left"},{value:"bottom-right",label:"Bottom Right"}];return I`
      <div class="section">
        <div class="section-header">
    ...
    `}_renderAlignmentSection(){const t=[{value:"left",label:"Left"},{value:"right",label:"Right"}],e=[{value:"top-left",label:"Top Left"},{value:"top-right",label:"Top Right"},{value:"bottom-left",label:"Bottom Left"},{value:"bottom-right",label:"Bottom Right"}];return I`
      <div class="section">
        <div class="section-header">
    ...
    `}};t([ut({attribute:!1})],Rt.prototype,"hass",void 0),t([pt()],Rt.prototype,"_config",void 0),t([pt()],Rt.prototype,"_expandedRule",void 0),Rt=t([ct("status-banner-card-editor")],Rt);export{Tt as StatusBannerCard,Rt as StatusBannerCardEditor};
