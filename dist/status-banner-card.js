...
`;let Rt=class extends rt{setConfig(t){if(!t.entity)throw new Error("You need to define an entity");this._config={...bt,...t,color_map:{...bt.color_map,...t.color_map}}}getCardSize(){return"compact"===this._config?.variant||"header-only"===this._config?.variant?2:3}shouldUpdate(t){if(t.has("_config"))return!0;if(t.has("hass")){const e=t.get("hass");if(!e)return!0;const i=this._config.entity;return e.states[i]!==this.hass.states[i]||(!(!this._config.timestamp_entity||e.states[this._config.timestamp_entity]===this.hass.states[this._config.timestamp_entity])||!(!this._config.secondary_info_entity||e.states[this._config.secondary_info_entity]===this.hass.states[this._config.secondary_info_entity]))}return!0}static getConfigElement(){return document.createElement("status-banner-card-editor")}static getStubConfig(){return{entity:"",rules:[{state:"on",title:"Active",subtitle:"System is running",icon:"mdi:check-circle",color:"#4CAF50"},{state:"off",title:"Inactive",subtitle:"System is idle",icon:"mdi:power-standby",color:"#9E9E9E"}],default:{title:"{{ state | upper }}",subtitle:"",icon:"mdi:information",color:"#2196F3"}}}render(){if(!this._config||!this.hass)return I``;const t=Et(this.hass,this._config.entity,this._config.rules,this._config.default,this._config.color_map,this._config.status_label),e=this._config.variant||"full",i=!1!==this._config.show_status&&"header-only"!==e,s=!1!==this._config.show_footer&&"header-only"!==e,a=!1!==this._config.show_accent,n=!1!==this._config.show_pattern,o=this._config.pattern_size??20,r=this._config.accent_width??60,c=this._config.accent_height??100;return I`
      <ha-card @click=${this._handleCardClick}>
        ...
        >
          ${a?I`<div
                class="card-accent ${n?"with-pattern":""}"
                style="--accent-color: ${t.color}; --accent-width: ${r}%; --accent-height: ${c}%; --pattern-size: ${o}px"
              ></div>`:V}
    ...
    `:I``}_renderButton(t,e){const i=this.hass.states[this._config.entity],s={hass:this.hass,entity:this._config.entity,state:i?.state||"",attr:i?.attributes||{},colorMap:this._config.color_map},a=t.label?gt(t.label,s):"Update";return I`
      <button
    ...
    `}};t([ut({attribute:!1})],zt.prototype,"hass",void 0),t([pt()],zt.prototype,"_config",void 0),t([pt()],zt.prototype,"_expandedRule",void 0),zt=t([lt("status-banner-card-editor")],zt);export{Rt as StatusBannerCard,zt as StatusBannerCardEditor};
