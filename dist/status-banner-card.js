      ...
      <ha-card @click=${this._handleCardClick}>
        ...
        >
          ${s?I`<div
                ...
                style="--accent-color: ${t.color}; --accent-width: ${o}%; --accent-height: ${r}%; --pattern-size: ${a}px"
              ></div>`:q}
          ${this._renderHeader(t)}
          ${e&&t.statusText?this._renderStatusBox(t):q}
          ${i?this._renderFooter(t):q}
        </div>
      </ha-card>
      ...
      <div class="header" style="--header-height: ${this._config.header_height}">
        <div class="header-content">
          ...
          ">
            ...
            ${t.subtitle?I`<div class="subtitle">${t.subtitle}</div>`:q}
          </div>
